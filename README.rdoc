...
The schema comments are kept at the begin or at the end of the file, using a format similar to:
...
If you want to put the schema comment at the begin of the file you can set position option:
